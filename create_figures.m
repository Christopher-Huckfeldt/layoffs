...
% opt.tmp = {'Recall', 'New Job', '(Recall + New Job)', 'Recall', 'New Job', '(Recall + New Job)'};
...
% % Create textbox
% annotation(gcf,'textbox',...
%     [0.347485745614036 0.447476246564584 0.342114035087719 0.0686878934103375],...
%     'String','Permanent Separation',...
%     'Interpreter','latex',...
%     'HorizontalAlignment','center',...
%     'FontSize',35,...
...
% % Create textbox
% annotation(gcf,'textbox',...
%     [0.345906798245614 0.918708284255986 0.342114035087719 0.0724620996238462],...
%     'String','Temporary Layoff',...
%     'Interpreter','latex',...
%     'HorizontalAlignment','center',...
%     'FontSize',35,...
